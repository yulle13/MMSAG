...
class Voc2007Classification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None, inp_name=None, adj=None):
        ...
        self.data_transforms = {
            'trainval': transforms.Compose([transforms.Resize((448,448)),
    ...
    def __getitem__(self, index):
        ...
        if self.set == 'trainval':
            ...
            text = "This is an image of kitchen waste maybe containing waste_bag,metal,shoe,plastic,bottle,carton,lile,glass ." 
        else:
            text = "This is an image of kitchen waste maybe containing waste_bag,metal,shoe,plastic,bottle,carton,lile,glass ." 
        # text = "This is an image of kitchen waste containing " + text[0] + "."
        return img, target, text, self.inp
