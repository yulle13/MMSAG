#############https://github.com/wutong16/DistributionBalancedLoss/blob/master/mllt/models/losses/resample_loss.py
...
class ResampleLoss(nn.Module):
    ...
    def __init__(self,
        ...
        self.class_freq = torch.from_numpy(np.asarray(mmcv.load(class_freq)['neg_class_freq'])).float().cuda()
