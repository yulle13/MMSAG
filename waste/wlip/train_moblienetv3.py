...
"""
test epoch[15/100] loss:0.716 test mAP:0.47151599653578313
checkpoint saved at /model/zfr888/ljt/LMPT/bert_resnet/weightbert_resnet_mAP:0.47151599653578313_voc-lt_btz_8_scratch.pt
head APs: {'waste_bag': 0.7241413862242835, 'plastic': 0.7148822427505049}, middle APs: {'bottle': 0.5990569323105315, 'carton': 0.41254323399754345, 'lile': 0.5606637043708319}, tail APs: {'metal': 0.26149681122949053, 'shoe': 0.2629693914917048, 'galss': 0.2363742699113746}
mAP head: 0.7195118144873942, mAP medium: 0.5240879568929689, mAP tail: 0.25361349087752333
"""
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            if current_mAP > best_mAP:
                ...
                if args.from_scratch is True:
                    torch.save(model.state_dict(), f'/model/zfr888/ljt/LMPT/bert_resnet/mobilev3_{args.dataset}_btz_{args.batch_size}_scratch.pt')
