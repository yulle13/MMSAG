...
''' Fixed in general '''
parser.add_argument('--data_root_dir', default='/data/zfr888/ljt/voc_clean_data', type=str, help='save path')
...
''' Train setting '''
parser.add_argument('--data', metavar='NAME', default='Waste',help='dataset name (e.g. COCO2014')
parser.add_argument('--model_name', type=str, default='TDRG')
parser.add_argument('--save_dir', default='/model/zfr888/swim-unet/多模态/TDRG/Waste/', type=str, help='save path')
