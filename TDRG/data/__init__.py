...
def make_data_loader(args, is_train=True):
    if args.data == 'Waste':
        root_dir = os.path.join(args.data_root_dir)
    elif args.data in ('VOC2007', 'VOC2012','COCO2014'):
    ...
    elif args.data == 'Waste':
        val_dataset = Waste(root_dir, phase='test', transform=transform)
    else:
        raise NotImplementedError('Value error: No matched dataset!')
    ...
    if args.data == 'COCO2014':
        ...
        train_dataset = Waste(root_dir, phase='trainval', transform=transform)
    else:
        raise NotImplementedError('Value error: No matched dataset!')
